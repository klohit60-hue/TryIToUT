          ...
          <div className="grid items-start gap-10 md:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex gap-3">
                <Link to="/auth" className="rounded-lg bg-gradient-to-r from-fuchsia-600 via-rose-500 to-cyan-500 px-5 py-3 text-sm font-medium text-white shadow hover:opacity-90">
                  Get Started
                </Link>
